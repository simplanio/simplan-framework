...
/**
  ...
  */
class SimplanConfigException(private val message: String = "", private val cause: Throwable = None.orNull) extends SimplanException(message, cause) with Serializable {
